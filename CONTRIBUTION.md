...
| **Zara** | ML, API, & Cloud | <ul><li>Implemented the cloud integration (D9).</li><li>Wrote the API documentation (D7) for the `README.md`.</li><li>Logged initial experiments to MLflow (D5).</li><li>Ran initial YOLO model tests.</li></ul> |
